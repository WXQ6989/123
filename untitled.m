...
params.stim.angleDeg_45 = 45; 
params.stim.angleDeg_20 = 20;
% left and right tilted bars
params.stim.NitemTypes = 3;
...
%--- 
%Get the tilted bars-------------------------------------------------
CubeTilted_45= imrotate(CubeVertical,params.stim.angleDeg_45,'bicubic','crop');
CubeTilted_20= imrotate(CubeVertical,params.stim.angleDeg_20,'bicubic','crop');
CubeTilted_45 = (CubeTilted_45> 0).*CubeTilted_45;
CubeTilted_20 = (CubeTilted_20> 0).*CubeTilted_20;
%--- small angle left and right tilted bar
CubeLeftTiltSmallAngle_45 = CubeTilted_45;   
CubeLeftTiltSmallAngle_20 = CubeTilted_20;

% Transpose to make it near horizontal
CubeLeftTiltSmallAngleNearHorizontal_45 = CubeLeftTiltSmallAngle_45';
CubeLeftTiltSmallAngleNearHorizontal_20 = CubeLeftTiltSmallAngle_20';
% flip horizontally to make right tilted bar
CubeRightTiltSmallAngleNearHorizontal_45 = CubeLeftTiltSmallAngleNearHorizontal_45(Sizebar:-1:1, :);
CubeRightTiltSmallAngleNearHorizontal_20 = CubeLeftTiltSmallAngleNearHorizontal_20(Sizebar:-1:1, :);

AllCubes = zeros(params.stim.NitemTypes, Sizebar, Sizebar);
AllCubes(1, :,:) = CubeLeftTiltSmallAngleNearHorizontal_45;
AllCubes(2, :,:) = CubeRightTiltSmallAngleNearHorizontal_45;
AllCubes(3, :,:) = CubeRightTiltSmallAngleNearHorizontal_20;
...
NTrials = params.stim.NTrialsPerCondition;
